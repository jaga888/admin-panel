<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <router-link :to="'/jurisdiction/serviceable-area/create/'">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column width="160" align="center" label="Actions">
        <template v-slot="scope">
          <router-link :to="'/jurisdiction/serviceable-area/edit/'+scope.row.id">
  ...
  methods: {
    getList() {
      ...
      let filteredData = this.data.filter(item => {
        const matchesCity = this.listQuery.city.toLowerCase() ? item.city.toLowerCase().includes(this.listQuery.city.toLowerCase()) : true;
        ...
        return matchesCity && matchesShortName;
      });
